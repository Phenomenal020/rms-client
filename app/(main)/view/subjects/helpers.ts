...
export const getStudentScores = (subjectName: string | null, student: Student | null, assessmentStructure: AssessmentStructure[] = []): Record<string, number> => {
...
export const calculateSubjectStats = (subjectName: string | null, enrolledStudents: Student[], assessmentStructure: AssessmentStructure[] = []): { average: number; minimum: number; maximum: number; classAverage: number } | null => {
